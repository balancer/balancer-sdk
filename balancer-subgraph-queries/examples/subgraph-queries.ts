...
import { OrderDirection, User_OrderBy } from '../generated/balancer-subgraph-types';
...
async function subgraphQueries() {
    ...
    const { pools: filteredPools } = await client.BalancerPools({ where: { totalLiquidity_gt: '1' } });
