...
export const BALANCER_NETWORK_CONFIG: Record<Network, BalancerNetworkConfig> = {
  ...
  [Network.KOVAN]: {
    ...
    vault: '0x436d7a3815ad4578adf44Bfe26daea4ff02d8D53',
    weth: '0xd0a1e359811322d97991e03f863a0c30c2cf029c',
    multicall: '0x2cc8688C5f75E365aaEEb4ea8D6a480405A48D2A',
    // subgraphUrl: 'https://api.thegraph.com/subgraphs/name/balancer-labs/balancer-kovan-v2',
    subgraphUrl: 'https://api.thegraph.com/subgraphs/name/dukedaily/balancer',
    staBal3Pool: {
