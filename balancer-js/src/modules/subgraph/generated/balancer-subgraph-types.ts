...
export const SubgraphPoolFragmentDoc = gql`
  ...
  snapshots(first: 2, orderBy: timestamp, orderDirection: desc) {
    swapFees
    timestamp
  }
  swapsCount
