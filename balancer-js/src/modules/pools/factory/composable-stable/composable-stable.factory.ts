...
export class ComposableStableFactory implements PoolFactory {
   ...
   *  * @param rateProviders
   *  * @param tokenRateCacheDurations
   *  * @param owner - The address of the owner of the pool
   *  * @param amplificationParameter
   *  * @param exemptFromYieldProtocolFeeFlags
   *  * @returns a SendTransactionOpts object, which can be directly inserted in the transaction to create a weighted pool
   */
  create({
    contractAddress,
    name,
