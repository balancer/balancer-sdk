...
async function getTokens(signerAddress: string): Promise<void> {
  ...
  await signer.provider.send('hardhat_impersonateAccount', ['0xF977814e90dA44bFA03b6295A0616a897441aceC'])
  const binance = signer.provider.getSigner('0xF977814e90dA44bFA03b6295A0616a897441aceC')

  await (
    await ERC20(dai, binance).transfer(signerAddress, amount)
  ).wait()
