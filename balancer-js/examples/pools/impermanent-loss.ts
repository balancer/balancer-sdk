 ...
 *
 * Run command:
 * yarn example ./examples/pools/impermanent-loss.ts
 */
...
const main = async (): Promise<void> => {
  ...
  await impermanentLoss(
    '0x000000000088e0120f9e6652cc058aec07564f69',
    '0x5c6ee304399dbdb9c8ef030ab642b10820db8f56000200000000000000000014'
  );
  await impermanentLoss(
    '0x07dd13b2705050b2f5c60da9f7f0f37b7395945a',
    '0xc45d42f801105e861e86658648e3678ad7aa70f900010000000000000000011e'
  );
  await impermanentLoss(
    '0x00bcfc8f7471b2e4d21af417dea393c1578c67c1',
