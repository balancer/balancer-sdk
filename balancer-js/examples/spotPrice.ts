...
import { BalancerSDK, Network, BalancerSdkConfig, PoolModel, BalancerError, BalancerErrorCode } from '../src/index';
...
async function getSpotPricePool() {
  ...
  const balDaiPool: PoolModel | undefined = await balancer.poolsProvider.find(balDaiPoolId);
