...
import { TokenPriceService, PoolDataService, SwapInfo, SOR, SubgraphPoolBase, SwapTypes, SwapV2 } from '@balancer-labs/sor';
...
import { Provider, JsonRpcProvider, JsonRpcSigner } from '@ethersproject/providers';
...
declare type PoolToken_Filter = {
    ...
    assimilator?: InputMaybe$1<Scalars$1['Bytes']>;
    assimilator_contains?: InputMaybe$1<Scalars$1['Bytes']>;
    assimilator_in?: InputMaybe$1<Array<Scalars$1['Bytes']>>;
    assimilator_not?: InputMaybe$1<Scalars$1['Bytes']>;
    assimilator_not_contains?: InputMaybe$1<Scalars$1['Bytes']>;
    assimilator_not_in?: InputMaybe$1<Array<Scalars$1['Bytes']>>;
    balance?: InputMaybe$1<Scalars$1['BigDecimal']>;
    balance_gt?: InputMaybe$1<Scalars$1['BigDecimal']>;
    balance_gte?: InputMaybe$1<Scalars$1['BigDecimal']>;
    balance_in?: InputMaybe$1<Array<Scalars$1['BigDecimal']>>;
...
declare type PoolsWithoutLinearQueryVariables = Exact$1<{
    skip?: InputMaybe$1<Scalars$1['Int']>;
    first?: InputMaybe$1<Scalars$1['Int']>;
    orderBy?: InputMaybe$1<Pool_OrderBy$1>;
    orderDirection?: InputMaybe$1<OrderDirection$1>;
...
declare type PoolWithoutLinearQueryVariables = Exact$1<{
    id: Scalars$1['ID'];
    block?: InputMaybe$1<Block_Height$1>;
}>;
...
declare class ProtocolFeesProvider {
    ...
    constructor(multicallAddress: string, protocolFeePercentagesProviderAddress: string, provider: Provider);
    private fetch;
...
declare class CoingeckoPriceRepository implements Findable<Price> {
    ...
    debounceWait: number;
    promisedCalls: PromisedTokenPrices[];
    promisedCount: number;
    timeout?: ReturnType<typeof setTimeout>;
    debounceCancel: () => void;
    constructor(tokenAddresses: string[], chainId?: Network);
    private fetch;
    private fetchNative;
    ...
    findBy(attribute: string, value: string): Promise<Price | undefined>;
    private platform;
    private addressMapIn;
    private unwrapToken;
    private url;
}

declare class AaveRates {
    private network;
    multicall: Contract;
    rates?: Promise<{
        [wrappedATokenAddress: string]: number;
    }>;
    constructor(multicallAddress: string, provider: Provider, network: Network);
    private fetch;
...
declare class TokenPriceProvider implements Findable<Price> {
    ...
    private aaveRates;
    constructor(coingeckoRepository: CoingeckoPriceRepository, aaveRates: AaveRates);
    find(address: string): Promise<Price | undefined>;
    findBy(attribute: string, value: string): Promise<Price | undefined>;
}
...
declare class TokenYieldsRepository implements Findable<number> {
    ...
    private sources;
    private yields;
    constructor(network: Network, sources?: {
...
interface PoolWithMethods extends Pool {
    ...
    calcSpotPrice: (tokenIn: string, tokenOut: string, isDefault?: boolean) => string;
}
...
declare class Liquidity {
    private pools;
    private tokenPrices;
    constructor(pools: Findable<Pool, PoolAttribute>, tokenPrices: Findable<Price>);
...
declare type JoinPoolData = JoinPoolRequest & EncodeJoinPoolInput;
...
declare class Contracts {
     ...
     * @returns Contract.
     */
    getLiquidityGauge(address: string, signerOrProvider: Signer | Provider): Contract;
}
...
declare type JoinAction = 'input' | 'batchSwap' | 'wrap' | 'joinPool' | 'wrapAaveDynamicToken' | 'wrapERC4626';
declare type ExitAction = 'output' | 'batchSwap' | 'unwrap' | 'exitPool' | 'unwrapAaveStaticToken' | 'unwrapERC4626';
...
declare class Join {
    ...
    constructor(pools: Findable<Pool, PoolAttribute>, networkConfig: BalancerNetworkConfig);
    joinPool(poolId: string, tokensIn: string[], amountsIn: string[], userAddress: string, wrapMainTokens: boolean, slippage: string, authorisation?: string): Promise<{
        to: string;
        callData: string;
        expectedOut: string;
        minOut: string;
    ...
    createCalls: (joinPaths: Node[][], userAddress: string, minAmountsOut?: string[], authorisation?: string) => Promise<{
        callData: string;
    ...
    amountsOutByJoinPath: (userAddress: string, callData: string, tokensIn: string[], outputIndexes: number[]) => Promise<{
        amountsOut: string[];
        totalAmountOut: string;
    }>;
    minAmountsOutByJoinPath: (slippage: string, amounts: string[], totalAmountOut: string) => {
        minAmountsOut: string[];
        totalMinAmountOut: string;
    };
    updateDeltas(deltas: Record<string, BigNumber>, assets: string[], amounts: string[]): Record<string, BigNumber>;
    createActionCalls: (joinPaths: Node[][], userAddress: string, minAmountsOut?: string[]) => {
        calls: string[];
        outputIndexes: number[];
        deltas: Record<string, BigNumber>;
    };
    ...
    createAaveWrap: (node: Node, nodeChildrenWithinJoinPath: Node[], joinPathIndex: number, sender: string, recipient: string) => string;
    createBatchSwap: (node: Node, nodeChildrenWithinJoinPath: Node[], joinPathIndex: number, expectedOut: string, sender: string, recipient: string) => [string, string[], string[]];
    createJoinPool: (node: Node, nodeChildrenWithinJoinPath: Node[], joinPathIndex: number, minAmountOut: string, sender: string, recipient: string) => [string, string[], string[], string];
    getOutputRefValue: (joinPathIndex: number, node: Node) => {
        value: string;
        isRef: boolean;
    };
}
...
declare class Exit {
    ...
    private tenderlyHelper;
    constructor(pools: Findable<Pool, PoolAttribute>, networkConfig: BalancerNetworkConfig);
    exitPool(poolId: string, amountBptIn: string, userAddress: string, slippage: string, authorisation?: string): Promise<{
        to: string;
        callData: string;
        tokensOut: string[];
        expectedAmountsOut: string[];
...
declare class Pools implements Findable<PoolWithMethods> {
     ...
     */
    generalisedJoin(poolId: string, tokens: string[], amounts: string[], userAddress: string, wrapMainTokens: boolean, slippage: string, authorisation?: string): Promise<{
        to: string;
        callData: string;
        minOut: string;
        expectedOut: string;
     ...
     */
    generalisedExit(poolId: string, amount: string, userAddress: string, slippage: string, authorisation?: string): Promise<{
        to: string;
        callData: string;
        tokensOut: string[];
        expectedAmountsOut: string[];
